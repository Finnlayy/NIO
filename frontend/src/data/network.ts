...
export const networkNodes: NetworkNode[] = [
  ...
  },
  {
    ...
    y: 24,
    description:
      "Model selection, hyperparameter tuning, and validation design for ml_30core workflows.",
  ...
  },
  {
    ...
    y: 24,
    description:
      "Recurrence derivation, complexity analysis, and correctness proofs for dynamic programming tasks.",
    tags: ["agent", "dev_dp"],
    sources: 2,
  },
  {
  ...
  },
  {
    ...
    y: 88,
    description:
      "Classic 0/1 knapsack with DP recurrence and complexity proof.",
    sources: 1,
  },
  {
    ...
    y: 68,
    description:
      "Compare XGBoost vs transformer architectures for tabular-sequence tasks.",
    sources: 1,
  },
  {
    id: "topic-lcs",
...
export const palette: Record<
  string,
  { border: string; fill: string; text: string; glow: string; line: string }
> = {
  yellow: {
    border: "#facc15",
...
export const taskPresets: Record<
  string,
  {
...
> = {
  ...
  "neural-core": {
    taskDescription:
      "Synthesize cross-domain insights across ML, DP, and prompt engineering benchmarks.",
    isComplexWorkflow: true,
    domainHint: "ml_30core",
    politenessTier: "neutral",
  },
