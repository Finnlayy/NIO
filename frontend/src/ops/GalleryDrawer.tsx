          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2.5">
              <button
                ...
                className="w-full text-left rounded-xl border border-amber-400/25 bg-amber-400/[0.06] p-3.5 hover:bg-amber-400/10 "
              >
              ...
              {widgetTemplates.map((tpl) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 inline-flex items-center gap-1 px-2.5 py-2 rounded-lg bg-cyan-400/10 border border-cyan-400/25 text-cyan-200 text-[11px] font-medium hover:bg-cyan-400/20 "
