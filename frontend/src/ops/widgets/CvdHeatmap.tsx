    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 mb-2.5">
        ...
        <div className="flex-1 h-1.5 rounded-full overflow-hidden flex relative">
          <div className="absolute inset-y-0 left-0 h-full transition-colors" style={{ width: "100%", background: "#34d399", transform: `scaleX(${buyPct / 100})`, transformOrigin: "left" }} />
          <div className="absolute inset-y-0 right-0 h-full transition-colors" style={{ width: "100%", background: "#f87171", transform: `scaleX(${sellPct / 100})`, transformOrigin: "right" }} />
        </div>
        <span className="text-[11px] text-slate-400">
      ...
      <div className="grid grid-cols-12 gap-1">
        {bins.map((bin, i) => (
          <div key={i} className="flex flex-col items-center gap-1 transition-colors">
            <div
              className="w-full h-14 rounded-md grid place-items-center transition-colors"
