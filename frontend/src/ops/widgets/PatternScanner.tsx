  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex relative h-1.5 rounded-full overflow-hidden mt-2.5">
        <div className="absolute inset-y-0 left-0 h-full" style={{ width: "100%", background: upBar, transform: `scaleX(${bullish / total})`, transformOrigin: "left" }} />
        <div className="absolute inset-y-0 right-0 h-full" style={{ width: "100%", background: downBar, transform: `scaleX(${bearish / total})`, transformOrigin: "right" }} />
      </div>
