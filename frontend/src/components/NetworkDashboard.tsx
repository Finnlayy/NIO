...
// ⚡ Bolt: Extracted derivations from static properties (`networkNodes`) outside the component.
// This skips the O(N) recalculation inside the render loop, completely bypassing the hook initialization
// logic that would otherwise run unnecessarily when relying on `useMemo` for static constants.
