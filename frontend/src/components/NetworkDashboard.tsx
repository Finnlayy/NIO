...
// ⚡ Bolt: Extracted static component properties to module scope.
// This prevents unnecessary derivations on render and avoids React useMemo hook overhead
// since networkNodes is a static configuration.
