...
// ⚡ Bolt: Extract derived static configurations outside the render loop
// These values rely entirely on the statically imported `networkNodes` and never change.
// Moving them out of the component avoids unnecessary React useMemo overhead on every render.
