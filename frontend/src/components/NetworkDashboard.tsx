...
// ⚡ Bolt Optimization: Derived state (like mapping nodes or filtering domains) based
// purely on static imports (e.g. `networkNodes`) should be extracted into module-level
// constants to prevent unnecessary calculations during the component's render loop and
// avoid the overhead of `useMemo` hooks.
