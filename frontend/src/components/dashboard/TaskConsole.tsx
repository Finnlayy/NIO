  ...
  return (
    <Tile className="p-4 h-full flex flex-col">
      ...
      <div
        ...
        title={!taskText.trim() ? "Enter a task description first" : undefined}
      >
        <button
          onClick={onRun}
          disabled={isRunning || !taskText.trim()}
          className="primary-button w-full flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0d16]"
        >
